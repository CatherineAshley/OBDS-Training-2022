...
```{r}
seurat_after_qc <- SCTransform(object=seurat_after_qc,assay="RNA", vars.to.regress = c("percent_mt"), variable.features.n = 2000)
seurat_after_qc
```
...
```{r}
VlnPlot(seurat_after_qc, features = c("nCount_RNA", "nCount_SCT"))
VlnPlot(seurat_after_qc, features = c("nFeature_RNA", "nFeature_SCT"))
```
