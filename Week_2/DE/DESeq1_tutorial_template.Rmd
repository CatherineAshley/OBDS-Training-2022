...
pheatmap(corr_dds)
pheatmap(corr_dds_pearson)corr_dds <- cor(assay(rlog_transformed_dds), method="spearman")
corr_dds_pearson <- cor(assay(rlog_transformed_dds), method="pearson")
...
## You can subset a dds object and interact with it like you would a Data
```{r}
